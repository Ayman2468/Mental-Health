...
class userrequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            "password.required" => __('msg.user password required'),
            "passwordconfirm.required" => __('msg.user password required'),
            ...
            "password.max" => __('msg.max number of charcters allawed is 20'),
