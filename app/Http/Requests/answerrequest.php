...
class answerrequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'answer' => "required|max:5000|min:100",
        ];
    }
    public function messages()
    {
        return [
            ...
            "answer.required" => __('msg.problem answer required'),
            ...
            "answer.max" => __('msg.max number of charcters allawed is 5000'),
            "answer.min" => __('msg.min number of charcters allawed is 100'),
        ];
    }
}
