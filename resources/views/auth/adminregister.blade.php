                ...
                <div class="card-body text-center">
                    ...
                    <form method="POST" action="{{route('admin.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('name_ar') is-invalid @enderror" name="name_ar" value="{{ $admindata->name_ar }}" autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('name_en') is-invalid @enderror" name="name_en" value="{{ $admindata->name_en }}" autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="college" type="text" class="form-control @error('college') is-invalid @enderror" name="college" value="{{$admindata->college}}" autocomplete="current-password">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="division" type="text" class="form-control @error('division') is-invalid @enderror" name="division" value="{{$admindata->division}}" autocomplete="current-password">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{$admindata->mobile}}" autocomplete="current-password">
