        ...
        <div class="col-md-8">
            <div class="card @if(LaravelLocalization::getcurrentlocale() == 'ar') text-right @endif">
                ...
                <div class="card-body text-center">
                    ...
                    @endif
                    <form method="POST" action="{{route('problems.update',$problemdata->id)}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $problemdata->title }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="content" cols="30" rows="15">{{ $problemdata->content }}</textarea>
                                @error('content')
                                    <span class="invalid-feedback text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
